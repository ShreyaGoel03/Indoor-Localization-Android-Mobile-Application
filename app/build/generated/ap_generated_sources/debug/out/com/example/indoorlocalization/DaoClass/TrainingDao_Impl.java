...
public final class TrainingDao_Impl implements TrainingDao {
  ...
  private final EntityInsertionAdapter __insertionAdapterOfTrainingEntity;
  ...
  public TrainingDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTrainingEntity = new EntityInsertionAdapter<TrainingEntity>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `Training`(`ID`,`Location`,`Orientation`,`RSSI_1`,`RSSI_2`,`RSSI_3`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
  ...
  @Override
  public List<TrainingEntity> getValues() {
    final String _sql = "SELECT * FROM Training";
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _item = new TrainingEntity(_tmpLocation,_tmpOrientation,_tmpRssi_1,_tmpRssi_2,_tmpRssi_3);
        final int _tmpID;
